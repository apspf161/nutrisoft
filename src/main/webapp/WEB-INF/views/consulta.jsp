...
<body>
	...
	<div class="container" id="container">
		...
		<form:form action="${addAction}" modelAttribute="consulta" method="POST">
			...
			<h4>Dados Laboratoriais</h4>
			
			<c:if test="${consulta.agendamento.cliente.dadoLaboratorial.data != null}">
				<div class="form-group">
		    		<form:label path="agendamento.cliente.dadoLaboratorial.data">Última Atualização</form:label>
		    		<c:out value="${consulta.agendamento.cliente.dadoLaboratorial.data}" />
				</div>
			</c:if>
			...
			Outros campos dos dados laboratoriais...

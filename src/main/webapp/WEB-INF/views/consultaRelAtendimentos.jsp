				...
				<div class="form-group email required user_horizontal_email">
					...
					<p>
						...
						<div class="input-group input-group-sm col-xs-5" style="margin: 10px 0 0 0;">
							...
							<select class="form-control" required="required" name="cmbNutricionista" >
							...
							<span class="input-group-btn" style="margin: 0 10px 0 0"> 
								<a id="btnFiltrarRelAtendimentos" class="btn btn-primary btn-sm" tabindex=0 role="button">Consultar</a>
							</span>
						</div>
					</p>
					
					<table class="display" id="content-table-atendimentos">
						<thead>
							<tr>
